...
def app():
    ...
    with st.form(key='survey_form'):
        ...
        st.write("")
        recommend01 = st.text_area(":two: :::로드뷰::: 멋진 장소, 의미있는/도움되는 장소, 산책길 등을 추천해 주실래요? (시간때/계절/추천사유 포함)")
        st.write("")
        recommend02 = st.text_area(":three: :::항공뷰::: 드론 360도 파노라마 뷰을 보고 싶은 장소를 말씀해주실래요? (시간때/계절/높이/추천사유 포함)")
        st.write("")
